...
public class Acciones_publicacion_ventana extends VerticalLayout {
	...
	protected Label meGustaNumLabel;
	protected Button verComentariosBtn;

	public Acciones_publicacion_ventana() {
		Design.read(this);
	}
}
